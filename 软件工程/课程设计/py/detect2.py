...
def run(
        ...
        data=ROOT / 'glassbroke.yaml',  # dataset.yaml path
    ...
    # 目录
    save_dir = Path(project) / name  # 不递增，直接指定目录
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'data/test1.jpg', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'glassbroke.yaml', help='(optional) dataset.yaml path')
